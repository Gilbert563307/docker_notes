...
export const PRIORITY_FILTER_TYPE_TAGS = [
    { id: TASKS_PRIORITY.LOW, name: "Low", config: TASKS_PRIORITY_TYPES_LOW },
    { id: TASKS_PRIORITY.MEDIUM, name: "Medium", config: TASKS_PRIORITY_TYPES_MEDIUM },
    { id: TASKS_PRIORITY.HIGH, name: "High", config: TASKS_PRIORITY_TYPES_HIGH },
];
