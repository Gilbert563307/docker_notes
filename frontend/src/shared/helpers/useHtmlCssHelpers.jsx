...
export default function useHtmlCssHelpers() {
  ...
  function getStatusBadge(status) {
    const statusBadgeMap = {
      [TASKS_STATUS.BACKLOG]: (
        <span className="badge badge-own rounded-pill badge-backlog">
          Backlog
        </span>
      ),
      [TASKS_STATUS.TODO]: (
        <span className="badge badge-own rounded-pill badge-todo">To do</span>
      ),
      [TASKS_STATUS.IN_PROGRESS]: (
        <span className="badge badge-own  rounded-pill badge-inprogress">
          In progress
        </span>
      ),
      [TASKS_STATUS.COMPLETED]: (
        <span className="badge badge-own rounded-pill  badge-completed">
          Completed
        </span>
      ),
    };
  ...
  function getStatusButton(status) {
    const statusBadgeMap = {
      [TASKS_STATUS.BACKLOG]: <span className="btn badge-backlog">Backlog</span>,
      [TASKS_STATUS.TODO]: <span className="btn badge-todo">To do</span>,
      [TASKS_STATUS.IN_PROGRESS]: (
        <span className="btn badge-inprogress">In progress</span>
      ),
      [TASKS_STATUS.COMPLETED]: (
        <span className="btn badge-completed ">Completed</span>
      ),
    };
  ...
  function getPriorityBadge(priority) {
    const priorityBadgeMap = {
      [TASKS_PRIORITY.LOW]: (
        <span className="badge badge-own rounded-pill badge-low">Low</span>
      ),
      [TASKS_PRIORITY.MEDIUM]: (
        <span className="badge badge-own rounded-pill badge-medium">
          Medium
        </span>
      ),
      [TASKS_PRIORITY.HIGH]: (
        <span className="badge badge-own rounded-pill badge-high">High</span>
      ),
    };
